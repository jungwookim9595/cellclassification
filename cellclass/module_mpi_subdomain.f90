...
module mpi_subdomain
    ...
    subroutine mpi_subdomain_mesh()
        ...
        if(UNIFORM1 == 1) then 
            ...
            do i = ista-1, iend+1
                x1_sub(i-ista+1) = &
                    L1*0.5d0*(1.d0 + tanh(0.5d0*GAMMA1*(2.d0*dble(i-1)/dble(N1m)-1.0d0))/tanh(GAMMA1*0.5d0) ) + x1_start
            end do

        end if
        if(pbc1.eqv..false. .and. comm_1d_x1%myrank==0) x1_sub(0)=x1_sub(1)
        ...
        if(pbc1.eqv..false. .and. comm_1d_x1%myrank==0) dx1_sub(0)=0.d0
        if(pbc1.eqv..false. .and. comm_1d_x1%myrank==comm_1d_x1%nprocs-1) dx1_sub(n1sub)=0.d0
        ...
        if(pbc1.eqv..false. .and. comm_1d_x1%myrank==comm_1d_x1%nprocs-1) dmx1_sub(n1sub)=0.5d0*(dx1_sub(n1msub)+dx1_sub(n1sub))
        ...
        if(pbc2.eqv..false. .and. comm_1d_x2%myrank==0) x2_sub(0)=x2_sub(1)
        ...
        if(pbc2.eqv..false. .and. comm_1d_x2%myrank==0) dx2_sub(0)=0.d0
        if(pbc2.eqv..false. .and. comm_1d_x2%myrank==comm_1d_x2%nprocs-1) dx2_sub(n2sub)=0.d0
        ...
        if(pbc2.eqv..false. .and. comm_1d_x2%myrank==comm_1d_x2%nprocs-1) dmx2_sub(n2sub)=0.5*(dx2_sub(n2msub)+dx2_sub(n2sub))
        ...
        if(pbc3.eqv..false. .and. comm_1d_x3%myrank==0) x3_sub(0)=x3_sub(1)
        ...
        if(pbc3.eqv..false. .and. comm_1d_x3%myrank==0) dx3_sub(0)=0.d0
        if(pbc3.eqv..false. .and. comm_1d_x3%myrank==comm_1d_x3%nprocs-1) dx3_sub(n3sub)=0.d0
        ...
        if(pbc3.eqv..false. .and. comm_1d_x3%myrank==comm_1d_x3%nprocs-1) dmx3_sub(n3sub)=0.5*(dx3_sub(n3msub)+dx3_sub(n3sub))
